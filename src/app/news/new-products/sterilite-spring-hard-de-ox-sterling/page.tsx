...
const product = getNewProduct("sterilite-spring-hard-de-ox-sterling");
...
export default async function Page() {
  const override = await tryManagedOverride("/news/new-products/sterilite-spring-hard-de-ox-sterling", {
